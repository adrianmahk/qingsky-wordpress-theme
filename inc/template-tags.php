...
if ( ! function_exists( 'twentysixteen_entry_date' ) ) :
	...
	function twentysixteen_entry_date() {
		...
		printf(
			...
			$time_string,
			get_the_modified_date()
			// strcasecmp((string) get_the_published_date(),(string)  get_the_modified_date())
		);
	}
endif;
...
if ( ! function_exists( 'twentysixteen_entry_taxonomies' ) ) :
	...
	function twentysixteen_entry_taxonomies() {
		$categories_list = get_the_category_list( _x( '</li><li class="pill-button ripple">', 'Used between list items, there is a space after the comma.', 'twentysixteen' ) );
		if ( $categories_list && twentysixteen_categorized_blog() ) {
			printf(
				// '<span class="cat-links"><span class="screen-reader-text">%1$s </span><li>%2$s</li></span>',
				'<ul class="tabs inpost"><li class="pill-button ripple">%2$s</li></ul>',
				_x( 'Categories', 'Used before category names.', 'twentysixteen' ),
				$categories_list
			);
		}

		$tags_list = get_the_tag_list( '', _x( '</li><li class="pill-button ripple">', 'Used between list items, there is a space after the comma.', 'twentysixteen' ) );
